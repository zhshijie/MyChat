...
//    password = [defaults objectForKey:@"password"];
    ...
    log = [[LoginViewController alloc]init];
    nav = [[BaseNavigationViewController alloc]initWithRootViewController:log];
//    [[User singleEample] getTheData:username password:password];
